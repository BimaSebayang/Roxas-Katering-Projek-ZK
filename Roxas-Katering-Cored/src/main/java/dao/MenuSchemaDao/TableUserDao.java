...
public interface TableUserDao extends JpaRepository<TableUser, TableUserPk>{
    ...
    @Query("select a.userId, a.pegawaiId, b.namaKaryawan from TableUser a,  TableDataKaryawan b "
    		...
    		+ " and "
    		+ " (  upper(a.userId) like upper(:search) "
    		+ "or upper(a.pegawaiId) like upper(:search) "
    		+ "or upper(b.namaKaryawan) like upper(:search) )")
    public List<Object[]> allActiveUserInCurrentProjek(@Param("search") String search, @Param("projekCode") String projekCode);
